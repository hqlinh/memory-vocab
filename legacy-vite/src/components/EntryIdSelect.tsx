...
import { searchEntriesByWord } from "@/lib/vocab-service";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { Badge } from "@/components/ui/badge";
import { X } from "lucide-react";
import { getEntriesByIds } from "@/lib/vocab-service";
...
export function EntryIdSelect({
  ...
  useEffect(() => {
    ...
    getEntriesByIds(ids).then((entries) => {
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(() => {
      searchEntriesByWord(query.trim(), excludeId).then((list) => {
